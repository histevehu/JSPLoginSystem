...
<%!
    public USER_NAME_TYPE judgeUserNameType(String userName)
    {
    ...
    public boolean isTrueUserName(String str)
    {
    ...
    public boolean legalCharCheck(String str)
    {
        for (int i = str.length(); --i >= 0; )
        {
    ...
    public boolean emailLegalCharCheck(String str)
    {
        for (int i = str.length(); --i >= 0; )
        {
    ...
    public boolean isUserExisted(String userName, USER_NAME_TYPE UNT)
    {
        try
        {
    ...
    public boolean verifyPwd(String userName, USER_NAME_TYPE UNT, String pwd)
    {
        try
        {
            DBHelper dbHelper = new DBHelper();
    ...
    public boolean isAdmin(String userName, USER_NAME_TYPE UNT)
    {
        try
        {
            DBHelper dbHelper = new DBHelper();
    ...
    public Object getLoginParameter(USER_NAME_TYPE input, String inParam, USER_NAME_TYPE output)
    {
        Object result=null;
        try
        {

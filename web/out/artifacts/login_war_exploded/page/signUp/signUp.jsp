...
<div class='pageContainer' style="overflow: hidden">
    ...
    <div class="containerDiv div-layout-center">
        <div class="formContainer">
            <form id="userSignUpInfoForm" method="post" action="_signUpProgress.jsp"
                ...
                <div class="div-input" id="signUp-birthday">
                    <div class="div-input-item">
                        ...
                        <input type="date" style="margin-left: 1vmin" id="userInfo_birthday" name="userInfo_birthday" required>
                    </div>
                </div>
            </form>
        </div>
